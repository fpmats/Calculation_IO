...
System = "Non-VDW-with_VDWcor-Layer-Analysis-Origianl-2L-Streached-"
MACE_model = "VASP-"
directory_path = "./"
dir_name = "Test_Theta*"
filename = "VASP.out"
string = "Total Energy from VASP:"
...
df = {"Difference added": Diff, "Layer Distance (A)": Layer, "Energy (eV)": E}
df = pd.DataFrame(df)
df = df.sort_values(by=["Layer Distance (A)"])
print(df)
