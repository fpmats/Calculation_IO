...
b = cell[1,1]
c = cell[2,2]
run_name = f'{dA:.02f}_{dB:.02f}_{c:.02f}_opt_vasp'    

#bc_rev_atoms.calc = Mixcalc
#atoms.set_constraint([FixSymmetry(atoms)])
atoms.calc = vasp_calc(vdw=True, run_name= "./")    
print("***Total Energy from VASP:", dA, dB, c, atoms.get_potential_energy())
db.write(atoms, a=a,b=b,c=c,dA=dA,dB=dB, model='vasp')   

#try:
#    db.get(a=a,b=b,c=c,dA=dA,dB=dB, model='vasp',opt_converged=True)
#except KeyError:
#    relax(atoms, run_name)
#    db.write(atoms, a=a,b=b,c=c,dA=dA,dB=dB, model='vasp', opt_converged=atoms.info['opt_converged'])   
