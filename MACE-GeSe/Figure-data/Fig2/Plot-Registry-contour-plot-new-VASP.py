...
for filename in os.listdir(dir_path):
    if filename.startswith("relax-11A-VASP.db"):
...
fig2.savefig("VASP/GeSe-Grid-Search-"+Points+MACE_model+"-3D-Rel-11A-min-energy.png", transparent=True)
