...
path_M = read_json('ASE-phonon-MACE/'+cutoff+'mybandpath.json')
bs_M = read_json('ASE-phonon-MACE/'+cutoff+'mybandstructure.json')
...
dos_df_M = pd.read_csv('ASE-phonon-MACE/'+cutoff+'dos_data.csv')
...
bs_pdos_vasp = pd.read_excel('projected_dos-VASP-VDW.xlsx', 'VASP')
...
fig.savefig("Phonon-bandstructure_MACE-VDW_vs_PBE.png", bbox_inches='tight')

#---------------------------------------------------------
## Read in VASP data and plots the band structure
#---------------------------------------------------------

with open('band-VASP-withVDW.yaml', 'r') as file:
